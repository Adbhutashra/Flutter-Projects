...
import 'package:testproject/Chat%20Application/models/message_chat.dart';
import 'package:testproject/Chat%20Application/pages/full_photo_page.dart';
...
class ChatPageState extends State<ChatPage> {
  ...
  Future getImagefromCamera() async {
    ImagePicker imagePicker = ImagePicker();
    XFile? pickedFile = await imagePicker.pickImage(source: ImageSource.camera).catchError((err) {
      Fluttertoast.showToast(msg: err.toString());
      return null;
    });
    if (pickedFile != null) {
