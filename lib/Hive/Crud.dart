...
import 'package:testproject/Hive/data_store.dart';
                                ...
                                IntrinsicHeight(
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(userData.description, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w500, ),
                                        ),
                                      ),
                                    ],
                                  ),
                                                ...
                                                builder: (context) => AlertDialog(
                                                  ...
                                                  actions: <Widget>[
                                                    TextButton(
                                                      ...
                                                      onPressed: () {dataStore.deleteUser(index: index, context: context);},
